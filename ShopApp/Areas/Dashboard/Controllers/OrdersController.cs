...
namespace ShopApp.Areas.Dashboard.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,AddressId,Amount,Status,CreatedAt,Id")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("UserId,AddressId,Amount,Status,CreatedAt,Id")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
